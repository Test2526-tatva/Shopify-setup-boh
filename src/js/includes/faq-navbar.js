...
/* product modal start */
function faqnavbar() {
    var $navLinks = $(".faq-heading .faq-group__link .nav-list");
    var $prevBtn = $(".faq-group__link .prev-btn");
    var $nextBtn = $(".faq-group__link .next-btn");
    ...
    $(".faq-group__link .next-btn").click(function () {
        var currentScroll = $navLinks.scrollLeft();
    ...
    $(".faq-group__link .prev-btn").click(function () {
        var currentScroll = $navLinks.scrollLeft();
